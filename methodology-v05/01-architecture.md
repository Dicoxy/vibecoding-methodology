...
Подробно: 03-changelog-rag.md, раздел 3.4
```
...
Здесь — краткая суть: changelog-запись создаётся в два этапа (ПЛАН до работы, ФАКТ после). Принцип Манифеста: документирование до, а не после. Формат строгий — RAG индексирует по структуре.

---

*Версия 1.2 | 19 февраля 2026*
*Обновлено: секция 1.4 перенесена в 03-changelog-rag.md, ссылки обновлены*
